        ...
        <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-6 lg:gap-8 items-stretch">
          <section className="relative overflow-hidden rounded-[28px] bg-slate-900 text-white p-8 sm:p-10 lg:p-12 min-h-[260px]">
            ...
            <div className="relative">
              ...
              <p className="text-[10px] font-black uppercase tracking-[0.35em] text-blue-300 mb-3">Secure Access</p>
              ...
              <p className="text-slate-200 max-w-lg text-sm sm:text-base leading-7">
                Access shipment visibility, request tracking, and service progress updates from one secure dashboard.
              </p>

              <div className="mt-8 grid sm:grid-cols-2 gap-3 text-[11px] font-black uppercase tracking-[0.18em]">
                <div className="rounded-xl border border-slate-700 bg-slate-800/70 px-4 py-3">Live Request Updates</div>
                <div className="rounded-xl border border-slate-700 bg-slate-800/70 px-4 py-3">Role-Based Access</div>
              </div>
            </div>
          </section>

          <section className="rounded-[28px] border border-slate-200 bg-white shadow-xl p-6 sm:p-8 lg:p-10 overflow-visible">
            <p className="text-[10px] font-black uppercase tracking-[0.35em] text-blue-600 mb-3">Portal Sign In</p>
            ...
            <div className="mt-8 pt-6 border-t border-slate-200 flex items-center justify-between gap-4">
              ...
              >
                Go To Signup <ArrowRight size={12} />
              </Link>
            </div>
          </section>
        </div>
